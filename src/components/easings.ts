...
export const easeInCube= `cubic-bezier(0.32, 0, 0.67, 0)`
export const easeOutCube= `cubic-bezier(0.33, 1, 0.68, 1)`
export const easeInOutCube= `cubic-bezier(0.65, 0, 0.35, 1)`
